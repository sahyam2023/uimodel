...
export function ConfigurationCard({ parameters, onParametersChange, isTraining }: ConfigurationCardProps) {
  ...
  return (
    <Card className="bg-slate-900 border-slate-800">
      ...
      <CardContent>
        <fieldset disabled={isTraining} className="group">
          <Tabs defaultValue="general" className="w-full">
            <TabsList className="grid w-full grid-cols-3 bg-slate-800 group-disabled:opacity-50">
            ...
            <div className="mt-6 space-y-6 group-disabled:opacity-50 group-disabled:cursor-not-allowed">
              ...
              <TabsContent value="hyperparameters" className="space-y-6 mt-0">
